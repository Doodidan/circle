...
BEGIN_MESSAGE_MAP(CkursovayaApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CkursovayaApp::OnAppAbout)
...
CkursovayaApp::CkursovayaApp()
{
	...
	SetAppID(_T("kursovaya.AppID.NoVersion"));
...
BOOL CkursovayaApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CkursovayaDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CkursovayaView));
	if (!pDocTemplate)
		return FALSE;
...
int CkursovayaApp::ExitInstance()
{
...
// обработчики сообщений CkursovayaApp
...
void CkursovayaApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CkursovayaApp настройка методов загрузки и сохранения

void CkursovayaApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CkursovayaApp::LoadCustomState()
{
}

void CkursovayaApp::SaveCustomState()
{
}
